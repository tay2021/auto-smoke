...
Resource    ../keyword/daily-bet-type-keywords.resource
...
As a user I want to check bao cao tong cuoc theo game category
    ...
    ${dict}    Get Current From Date And To Date Selected By Default On Chi Tiet Quan Ly Dai Ly Theo Game Category
    ${from_date}    Set Variable    ${dict.from_date}
    ${to_date}    Set Variable    ${dict.to_date}
